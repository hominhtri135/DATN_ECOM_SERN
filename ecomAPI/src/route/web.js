...
const typeshipController = require("../controllers/typeshipController");
...
const middlewareControllers = require("../middlewares/jwtVerify");
...
const initwebRoutes = (app) => {
  ...
  //=================API STATISTIC==============================//
  router.get(
    "/api/get-user-cancel-order-rate-statistic",
    // middlewareControllers.verifyTokenAdmin,
    statisticController.getUserCancelOrderRateStatistic
  );
  //====================================================//
  router.get(
  ...
  router.get(
    "/api/get-statistic-sold-product",
    // middlewareControllers.verifyTokenAdmin,
    statisticController.getStatisticSoldProduct
  );
  //=================API SUPPLIER================================//
  router.post(
