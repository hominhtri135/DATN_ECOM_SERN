...
const handleCreateNewAllCode = (data) => {
...
const handleUpdateAllCode = (data) => {
  return new Promise(async (resolve, reject) => {
    try {
...
const handleDeleteAllCode = (allcodeId) => {
  return new Promise(async (resolve, reject) => {
    try {
      if (!allcodeId) {
        resolve({
        ...
        const foundAllCode = await db.Allcode.findOne({
          where: { id: allcodeId },
        });
        if (!foundAllCode) {
          resolve({
...
const getAllCategoryBlog = (typeInput) => {
  return new Promise(async (resolve, reject) => {
    try {
      if (!typeInput) {
        resolve({
