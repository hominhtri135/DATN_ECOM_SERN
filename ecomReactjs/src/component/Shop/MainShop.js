...
function MainShop(props) {
  ...
  let handleSelectSort = async (event) => {
    ...
    if (value === 1) {
      ...
      loadProduct(limitPage, "", "ASC", offset, categoryId, keyword);
      setsortPrice(true);
      setsortName("");
    } else if (value === 3) {
      loadProduct(limitPage, "", "DESC", offset, categoryId, keyword);
      setsortPrice("");
      setsortName(true);
    } else if (value === 4) {
      ...
      <div className="product_top_bar">
        <div className="left_dorp">
          ...
          >
            ...
            <option value={2}>Theo giá tiền thấp đến cao</option>
            <option value={3}>Theo giá tiền cao đến thấp</option>
