...
function OrderHomePage(props) {
  ...
  const [activeTypeOnlPayment, setactiveTypeOnlPayment] = useState();
  ...
  let handleSaveOrder = async () => {
    ...
    if (activeTypePayment === undefined) {
      toast.error("Chưa chọn phương thức thanh toán");
      return;
    }
    if (activeTypePayment === 1 && !activeTypeOnlPayment) {
      toast.error("Chưa chọn phương thức thanh toán online");
      return;
    }

    let result = dataCart.map((item, index) => {
      return {
    ...
    if (activeTypePayment === 0) {
      ...
      if (activeTypeOnlPayment === 1) {
        ...
        let res = await paymentOrderVnpayService({
          orderType: "200000",
          orderDescription: `Thanh toan hoa don: user[${userId}]:amount[${total}]:time[${Date.now()}]`,
          bankCode: "",
          language: "vn",
          amount: total,
        });
  ...
  useEffect(() => {
    console.log({ activeTypeOnlPayment, activeTypePayment });
  }, [activeTypeOnlPayment, activeTypePayment]);
              ...
              <div className="box-shopcart-bottom">
                <div className="content-left">
                  <div className="wrap-voucher">
                    ...
                    ></img>
                    <span className="name-easier">Lialili voucher</span>
                    <span
        ...
        <div className="wrap-payment">
          ...
          <div className="content-bottom">
            <div className="wrap-bottom">
              ...
              <div className="box-flex">
                <div onClick={() => handleSaveOrder()} className="main_btn">
                  Đặt hàng
                </div>
              </div>
            </div>
