              ...
              <tbody>
                {dataStockProduct &&
                  ...
                  dataStockProduct.map((item, index) => {
                    let name = `${item.productData.name} - ${item.productDetaildData.nameDetail} - ${item.sizeData.value}`;
                    return (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        <td>{name}</td>
                        <td>{item.productData.categoryData.value}</td>
                        <td>{item.productData.brandData.value}</td>
                        <td>{item.productData.material}</td>
                        <td>{item.stock}</td>
                      </tr>
                    );
                  })}
