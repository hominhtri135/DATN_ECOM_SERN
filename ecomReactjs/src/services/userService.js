...
const handleSendVerifyForgotPassword = (data) => {
  return axios.post(`/api/send-forgotpassword-email`, data);
};
const handleVerifyForgotPassword = (data) => {
  return axios.post(`/api/forgotpassword-email`, data);
};
...
//======================STATISTIC========================//
const getRateOrderUserStatistic = (data) => {
  return axios.get(
    `/api/get-user-cancel-order-rate-statistic?oneDate=${data.oneDate}&twoDate=${data.twoDate}&type=${data.type}`
  );
};
const getStaticSoldProduct = (data) => {
  return axios.get(
    `/api/get-statistic-sold-product?sortby=${data.sortby}&limit=${data.limit}&oneDate=${data.oneDate}&twoDate=${data.twoDate}&type=${data.type}`
  );
};
